<template>
    <nav :class="{ 'bg-white': isScrolled }" class="fixed w-full z-20 top-0">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
            <img src="/images/logo.png" class="h-8" alt="Logo">
            <div class="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button @click="scrollToTop" type="button" class="text-white bg-red-800 hover:bg-black hover:text-white font-medium rounded-lg text-sm px-4 py-2 text-center">Back to Home</button>
